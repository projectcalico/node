...
Param(
    [parameter(Mandatory = $false)] $ReleaseBaseURL="https://github.com/song-jiang/calico/releases/download/song-test1/",
    [parameter(Mandatory = $false)] $ReleaseFile="calico-os-master.zip",
