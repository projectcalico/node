...
// detection method.
func AutoDetectCIDR(method string, version int, k8sNode *v1.Node, defInterfacesToExclude []string, getInterfaces func([]string, []string, int) ([]Interface, error)) *cnet.IPNet {
