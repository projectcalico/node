...
calico/node is licensed under the [Apache v2.0 license](LICENSE).

It includes a number of differently licensed dependencies, whose licenses are included in the [filesystem/licenses](filesystem/licenses) directory.
