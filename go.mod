...
require (
	...
	github.com/projectcalico/felix v0.0.0-20210626114958-1b3a8b61e15c
...
replace (
	...
	github.com/kelseyhightower/confd => github.com/projectcalico/confd v1.0.1-0.20210626000936-0285b9e12735
