...
require (
	...
	github.com/projectcalico/felix v0.0.0-20200911161946-7a7ffc82e2a8
...
replace (
	...
	github.com/kelseyhightower/confd => github.com/projectcalico/confd v1.0.1-0.20200911080659-a40f61e64a2e
