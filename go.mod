...
require (
	...
	github.com/projectcalico/felix v0.0.0-20210323172227-4b5bac76ff03
...
replace (
	github.com/kelseyhightower/confd => github.com/projectcalico/confd v1.0.1-0.20210323011057-cf9bd0cc98da
