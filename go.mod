...
require (
	...
	github.com/projectcalico/felix v0.0.0-20210531192137-d711ce268887
...
replace (
	...
	github.com/kelseyhightower/confd => github.com/projectcalico/confd v1.0.1-0.20210525165507-d2e349a422ee
