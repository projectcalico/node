...
require (
	...
	github.com/projectcalico/felix v0.0.0-20200825014831-66ac482cdb8b
...
replace (
	github.com/kelseyhightower/confd => github.com/projectcalico/confd v1.0.1-0.20200825025339-0cbb115a7858
