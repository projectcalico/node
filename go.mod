...
require (
	...
	github.com/projectcalico/typha v0.7.3-0.20201118041127-ee30dae4ca28
...
replace (
	...
	github.com/kelseyhightower/confd => github.com/projectcalico/confd v1.0.1-0.20201118043643-e99babc41ca3
