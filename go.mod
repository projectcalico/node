...
require (
	...
	github.com/projectcalico/cni-plugin v1.11.1-0.20220203232229-e4d66a9549c7
...
replace (
	...
	github.com/kelseyhightower/confd => github.com/projectcalico/confd v1.0.1-0.20220203232208-add9be1bb19b
