...
require (
	...
	github.com/projectcalico/felix v0.0.0-20200325095026-50a7004db232
...
replace (
	github.com/kelseyhightower/confd => github.com/projectcalico/confd v1.0.1-0.20200326080957-b26b4d1e04c0
