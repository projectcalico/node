...
replace (
	...
	github.com/kelseyhightower/confd => github.com/projectcalico/confd v1.0.1-0.20210410011115-a4d1658c655e
	github.com/projectcalico/cni-plugin => github.com/lmm/cni-plugin v1.11.1-0.20210331185452-fbdcc2b573f7
