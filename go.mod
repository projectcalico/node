...
require (
	...
	github.com/projectcalico/felix v0.0.0-20210715004358-b9a22168970f
...
replace (
	...
	github.com/kelseyhightower/confd => github.com/projectcalico/confd v1.0.1-0.20210714234710-433933c8e494
